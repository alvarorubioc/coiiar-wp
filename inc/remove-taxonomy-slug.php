...
function change_term_request($query){
	...
	$tax_name = 'category-events'; // specify you taxonomy name here, it can be also 'category' or 'post_tag'
...
function rudr_term_permalink( $url, $term, $taxonomy ){
	...
	$taxonomy_name = 'category-events'; // your taxonomy name here
	$taxonomy_slug = 'category-events'; // the taxonomy slug can be different with the taxonomy name (like 'post_tag' and 'tag' )
...
function rudr_old_term_redirect() {
	...
	$taxonomy_name = 'category-events';
	$taxonomy_slug = 'category-events';
